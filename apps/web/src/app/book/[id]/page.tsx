    ...
    <AppShell>
      ...
      <header className="px-4 pt-4">
        <div className="flex gap-4">
          <div className="aspect-[3/4] w-32 shrink-0 overflow-hidden rounded-xl bg-muted">
        ...
        <div className="mt-5 grid grid-cols-3 divide-x rounded-2xl border bg-card text-center">
          <Stat label="Chapters" value={book.totalChapters.toString()} />
          <Stat label="Words" value={formatWordCount(wordsTotal || estimateWords(book))} />
...
function BookJsonLd({ book, rating }: { book: BookDetail; rating: number }): JSX.Element {
  ...
  return (
    <script
      ...
      // Stringifying via JSON.stringify avoids HTML-injection risks; the
      // payload comes from our own DB through the API.
